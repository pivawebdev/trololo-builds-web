    ...
    <div className="min-h-screen bg-[#1a120b] flex items-center justify-center p-4">
      <div className="bg-[#2c2118] rounded-xl border border-amber-800/40 p-8 max-w-md w-full">
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-[#5865F2] hover:bg-[#4752C4] text-white font-bold py-3 px-4 rounded-lg transition flex items-center justify-center gap-3 disabled:opacity-50"
        >
          ...
          {loading ? 'Carregando...' : 'Entrar com Discord'}
        </button>
